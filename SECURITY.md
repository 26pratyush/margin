...
Margin is local-first by design. The working finance application is not intended to be a hosted multi-user service.
...
For a private concern, contact the repository owner directly rather than opening a public issue with sensitive details.

Copyright © 2026 Pratyush

Required Notice: Copyright © 2026 Pratyush

Margin is licensed under the PolyForm Noncommercial License 1.0.0.
The complete license terms follow.

The `Yoyodyne` line in the standardized terms below is an illustrative
example from the official PolyForm license text; it is not a Margin notice.
...
that covers patent claims the licensor can license, or becomes able
...
substantially all the assets of that organization, or the power to
